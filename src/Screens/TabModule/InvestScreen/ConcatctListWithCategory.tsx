...
const ConcatctListWithCategory = (props: InvestScreenProps) => {
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        <ScrollView style={{ padding: 10 }}>
                            ...
                            <TouchableOpacity onPress={handleClearFunction} style={[styles.filterButton, { backgroundColor: '#ccc', marginTop: 10 }]}>
...
export default ConcatctListWithCategory;
