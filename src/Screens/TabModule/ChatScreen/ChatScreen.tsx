...
const ChatScreen: React.FC<ChatScreenProps> = (props) => {
  ...
  useEffect(() => {
    if (userId) {
      ...
      socketServices.emit('join_room', { userId: user._id, receiverId: userId });

      // Load previous messages
      socketServices.on('loadMessages', (loadedMessages: any) => {
  ...
  useEffect(() => {
    ...
    socketServices.on('receiveMessage', (message: any) => {
      console.log(" ================================== received message inner chat ============================================== ");
